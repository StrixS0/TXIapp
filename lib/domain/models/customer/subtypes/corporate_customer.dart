...
class CorporateCustomer extends Customer{
  ...
  CorporateCustomer({required CustomerId id, required Profile profile, required UserId userId, required Status status, required DateTime created, required DateTime modified, required String company}) 
    : _company = company,
      super(id: id, profile: profile, userId: userId, status: status, created: created, modified: modified);
