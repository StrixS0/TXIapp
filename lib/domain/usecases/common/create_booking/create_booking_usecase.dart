  ...
  Result<Booking> execute(CreateBookingRequest request) {
    try {
      ...
      if (request.airport != null) {
        airportInfo = AirportInfo.create(
            airport: request.airport!, privateAirport: request.privateAirport);
      }

      return Result.success(_bookingService.createBooking(
          bookingType: request.bookingType,
          vehicleType: request.vehicleType,
          passenger: Passenger.create(
              passengerCount: request.passengerCount,
              withLuggage: request.withLuggage),
          dayAndTime: request.dayAndTime,
          profile: request.profile,
          customerId: request.customerId,
          airportInfo: airportInfo,
          tripType: request.tripType,
          waitingTime: request.waitingTime,
          byHourDuration: request.byHourDuration,
          locationType: request.locationType,
          pickupOrDropoffAddress: Address(
              address: request.pickupAddress,
              additional: request.pickupAdditional,
          ...
          dropoffAddress: request.dropoffAddress == null
              ...
              : Address(
                  ...
                  additional: request.dropoffAdditional,
                  city: request.dropoffCity,
                  postalCode: request.dropoffPostalCode!,
