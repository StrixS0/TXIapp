...
import 'package:txiapp/presentation/utils/router.dart' as nav;
...
class SignupPersonalVieModel extends ChangeNotifier{
  ...
  void _formSubmitted() async{
    ...
    nav.Router.navigateTo(Screen.createPassword, arguments: {
      'type': signupPersonalState.type,
      'company': signupPersonalState.company,
      'profile': signupPersonalState.profile,
      'address': signupPersonalState.addressObject
    });
  }
